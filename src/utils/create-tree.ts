...
export function simpleTreeGenerator(scene: Scene): Mesh {
	...
	// Tree trunk
	const treeTrunk = MeshBuilder.CreateCylinder('treeTrunk', { height: 2, diameter: 1, tessellation: 6 }, scene);
	const treeTrunkMaterial = new StandardMaterial(MaterialID.TREE_TRUNK, scene);
